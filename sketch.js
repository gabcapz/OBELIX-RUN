...
function setup() {
  ...
  obelix = createSprite(-120, height-170);
  obelix.addAnimation("running", obelix_running);
  obelix.scale = 0.2;
  
  pig = createSprite(width-30, 150);
  ...
  heart = createSprite(width-170, height-150);
  heart.addImage(heartImage);
  heart.scale = 0.35;
  
  heart1 = createSprite(width-130, height-150);
  heart1.addImage(heartImage);
  heart1.scale = 0.35;
  
  heart2 = createSprite(width-90, height-150);
